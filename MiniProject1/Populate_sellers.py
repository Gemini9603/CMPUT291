...
import pandas as pd
import sqlite3
conn = sqlite3.connect("./Large.db")    #TODO: Change the database name as requi
c = conn.cursor()
c.execute('PRAGMA foreign_keys=ON;')

data = pd.read_csv(r'./olist_sellers_dataset.csv')
...
row = column.sample(n=1000)   #TODO: Change number of rows according to database
